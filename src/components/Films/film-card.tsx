...
const favoriteFilms = 'favoritesFilms';
...
const FilmCard = ({ title, rating, year, poster, id }: Props) => {
  ...
  useEffect(() => {
    checkFavorites(favoriteFilms, setIsFavorite);
    checkFavorites(watchLater, setIsWatchLater);
  }, [userStatus]);
          ...
          <div className={styles.rating}>
            ...
            <div className={styles.images}>
              <button
                ...
                onClick={() =>
                  addFavorites(favoriteFilms, isFavorite, setIsFavorite)
                }
              >
                <svg
              ...
              <button
                ...
                onClick={() =>
                  addFavorites(watchLater, isWatchLater, setIsWatchLater)
                }
              >
                <svg
                  width="17"
          ...
          <div className={styles.more}>
            ...
            <Link
              onClick={() => {
                ...
                localStorage.setItem(isDetailsOpen, JSON.stringify(true));
              }}
              to={`/film/${id}`}
